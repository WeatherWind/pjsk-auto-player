...
| **v5.0.0** | 🖥️ MAA スタイルネイティブデスクトップ GUI + 検出対策 + イベント検出 |
...
本ソフトウェアは学習・研究目的です。使用により Project Sekai (SEGA/Colorful Palette) の利用規約に違反する可能性があります。ユーザーはすべてのリスクと責任を負います。開発者はアカウント停止やその他の結果について一切の責任を負いません。
